...
final class Rules
{
    ...
    public static function required($errormessage = null): Rule
    {
    ...
    public static function notFalsy($errormessage = null): Rule
    {
    ...
    public static function notNull($errormessage = null): Rule
    {
    ...
    public static function null($errormessage = null): Rule
    {
    ...
    public static function notEmptyString($trim = false, $errormessage = null): Rule
    {
    ...
    public static function emptyString($trim = false, $errormessage = null): Rule
    {
    ...
    public static function string($allowEmpty = true, $trimBeforeCheckEmpty = false, $toTrim = false, $errormessage = null): Rule
    {
    ...
    public static function digitsString($trim = false, $errormessage = null): Rule
    {
    ...
    public static function intString($trim = false, $errormessage = null): Rule
    {
    ...
    public static function boolString($errormessage = null): Rule
    {
    ...
    public static function intBool($strict = false, $errormessage = null): Rule
    {
    ...
    public static function file($errormessage = null): Rule
    {
        $ruleID = self::ID_FILE;
    ...
    public static function int($errormessage = null): Rule
    {
        $ruleID = self::ID_INT;
    ...
    public static function floatOrInt($errormessage = null): Rule
    {
    ...
    public static function number($errormessage = null): Rule
    {
    ...
    public static function float($strictFloat = true, $errormessage = null): Rule
    {
    ...
    public static function floatString($strictFloat = true, $trim = false, $errormessage = null): Rule
    {
    ...
    public static function numberString($trim = false, $errormessage = null): Rule
    {
        $ruleID = self::ID_FLOAT_STRING;
        $ruleFn = function (Context $c) use ($trim): bool {
            $trim = Helpers::valueOrFunction($trim, $c);
    ...
    public static function undefined($errormessage = null): Rule
    {
    ...
    public static function bool($errormessage = null): Rule
    {
        $ruleID = self::ID_BOOL;
    ...
    public static function email($errormessage = null): Rule
    {
    ...
    public static function equals($value, $strict = true, $errormessage = null): Rule
    {
        $ruleID = 'equals';
    ...
    public static function notEquals($value, $strict, $errormessage = null): Rule
    {
        $ruleID = 'notEquals';
        $ruleFn = function (Context $c) use ($value, $strict): bool {
            $value = Helpers::valueOrFunction($value, $c);
    ...
    public static function phone($errormessage = null): Rule
    {
     ...
     */
    public static function date($format = 'Y-m-d', string|callable|null $errormessage = null): Rule
    {
        $ruleID = self::ID_DATE;
    ...
    public static function min(\Brick\Math\BigNumber|int|float|string $min, $errormessage = null): Rule
    {
        $ruleID = self::ID_MIN;
    ...
    public static function max(\Brick\Math\BigNumber|int|float|string $max, $errormessage = null): Rule
    {
        $ruleID = self::ID_MAX;
    ...
    public static function minDate(Datetime $date, $sourceFormat = 'Y-m-d', $errormessage = null): Rule
    {
    ...
    public static function maxDate(Datetime $date, $sourceFormat = 'Y-m-d', $errormessage = null): Rule
    {
    ...
    public static function between(Datetime $minDate, Datetime $maxDate, $sourceFormat = 'Y-m-d', $errormessage = null): Rule
    {
    ...
    public static function notBetween(Datetime $minDate, Datetime $maxDate, $sourceFormat = 'Y-m-d', $errormessage = null): Rule
    {
        $ruleID = self::ID_DATE_BETWEEN;
        $ruleFn = function (Context $c) use ($minDate, $maxDate, $sourceFormat): bool {
            $minDate = Helpers::valueOrFunction($minDate, $c);
    ...
    public static function array($errormessage = null): Rule
    {
    ...
    public static function scalar($errormessage = null): Rule
    {
    ...
    public static function in($array, $strict = true, $errormessage = null): Rule
    {
    ...
    public static function notInArray($array, $errormessage = null): Rule
    {
    ...
    public static function ruleEndsWith(string $endsWith, $ignoreCase = true, $errormessage = null): Rule
    {
        $ruleID = 'endsWith';
    ...
    public static function ruleStartsWith(string $startsWith, $ignoreCase = true, $errormessage = null): Rule
    {
        $ruleID = 'startsWith';
    ...
    public static function ruleContains(string $contains, $ignoreCase = true, $errormessage = null): Rule
    {
        $ruleID = 'contains';
    ...
    public static function ruleMinLength($length, $errormessage = null): Rule
    {
        $ruleID = 'minLength';
    ...
    public static function ruleMaxLength($length, $errormessage = null): Rule
    {
        $ruleID = 'maxLength';
        $ruleFn = function (Context $c) use ($length): bool {
            $length = Helpers::valueOrFunction($length, $c);
    ...
    public static function ruleLength(int $length, $errormessage = null): Rule
    {
        $ruleID = 'length';
        $ruleFn = function (Context $c) use ($length): bool {
            $length = Helpers::valueOrFunction($length, $c);
